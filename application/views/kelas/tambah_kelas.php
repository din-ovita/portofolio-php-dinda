...
<body class="d-flex gap-5">
    ...
    <div style="width: 80%; margin-right: 2rem;" class="mt-5">
        <div class="shadow-lg p-5 rounded-3">
            <h1>ADD KELAS</h1>
            <form class="mt-5 row" action="<?php echo base_url('admin/aksi_add_kelas') ?>" method="post">
                <div class="mb-3 col-6">
                    <label for="exampleInputEmail1" class="form-label">Tingkat Kelas</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="tingkat" placeholder="Tingkat kelas..">
                </div>
                <div class="mb-3 col-6">
                    <label for="exampleInputEmail1" class="form-label">Jurusan Kelas</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="jurusan" placeholder="Jurusan kelas..">
                </div>
                <div class="mb-3 col-6">
